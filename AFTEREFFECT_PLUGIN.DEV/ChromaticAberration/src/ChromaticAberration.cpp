	...
	PF_LayerDef		*output)
{
	PF_SPRINTF(
		...
		"%s, v%d.%d\r%s",
		strName,
		ChromaticAberration_VersionMajor,
		ChromaticAberration_VersionMinor,
		strCopyright);
	...
	PF_LayerDef		*output)
{
	...
	out_data->my_version =
		PF_VERSION(
			ChromaticAberration_VersionMajor,
			ChromaticAberration_VersionMinor,
			ChromaticAberration_VersionSub,
			ChromaticAberration_VersionStage,
			ChromaticAberration_VersionBuild
		);
