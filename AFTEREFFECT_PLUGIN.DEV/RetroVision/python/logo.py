...
def draw_palette_pattern_logo(filename, palette, split_size_x, split_size_y):
    ...
    for y in range(0, LOGO_SIZE, split_size_y):
        for x in range(0, LOGO_SIZE, split_size_x):
            ...
            # Ensure we don't draw beyond the LOGO_SIZE boundary
            ...
            # Move to the next color in the palette for the next square
            color_index += 1
            
            # If we've used all palette colors and need more squares, cycle through palette
            # (This ensures we always have a color for every square)
...
if __name__ == "__main__":
    if not os.path.exists("retro_logos_pattern"):
        os.makedirs("retro_logos_pattern")

    # --- CGA Logos (48x48 split into 2x2 squares of 24x24) ---
    # CGA P0 Normal
    draw_palette_pattern_logo("retro_logos_pattern/cga_p0_n_pattern.png", CGA_P0_N_PALETTE, 24, 24)
    # CGA P0 Intense
    draw_palette_pattern_logo("retro_logos_pattern/cga_p0_i_pattern.png", CGA_P0_I_PALETTE, 24, 24)
    # CGA P1 Normal
    draw_palette_pattern_logo("retro_logos_pattern/cga_p1_n_pattern.png", CGA_P1_N_PALETTE, 24, 24)
    # CGA P1 Intense
    draw_palette_pattern_logo("retro_logos_pattern/cga_p1_i_pattern.png", CGA_P1_I_PALETTE, 24, 24)

    # --- EGA Logos (48x48 split into 4x4 squares of 12x12) ---
    # EGA Standard
    draw_palette_pattern_logo("retro_logos_pattern/ega_std_pattern.png", EGA_STANDARD_PALETTE, 12, 12)
    # EGA KQ3
    draw_palette_pattern_logo("retro_logos_pattern/ega_kq3_pattern.png", PALETTE_KQ3, 12, 12)
    # EGA Thexder
    draw_palette_pattern_logo("retro_logos_pattern/ega_thexder_pattern.png", PALETTE_THEXDER, 12, 12)