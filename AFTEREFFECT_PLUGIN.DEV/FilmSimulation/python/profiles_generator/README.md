...
|---|---|---|---|
| **`film_sim.py`** | the model of record. Every parameter is read here first and every audit re-derives its numbers against this | 27 / 27 stages | the reference for *meaning* |
