...
PF_Err FilmSimulation_InAE_16bits
(
	PF_InData*   in_data,
	PF_OutData*  out_data,
	PF_ParamDef* params[],
...
PF_Err FilmSimulation_InAE_32bits
(
    PF_InData*   in_data,
    PF_OutData*  out_data,
    PF_ParamDef* params[],
...
inline PF_Err FilmSimulation_InAE_DeepWorld
(
    PF_InData*   in_data,
    PF_OutData*  out_data,
    PF_ParamDef* params[],
...
) noexcept
{
	return (PF_WORLD_IS_DEEP(output) ?
        FilmSimulation_InAE_DeepWorld (in_data, out_data, params, output) :
        FilmSimulation_InAE_8bits (in_data, out_data, params, output));
}