...
inline PF_Err AutomaticWhiteBalance2_InAE_DeepWorld
(
    PF_InData*   in_data,
    PF_OutData*  out_data,
    PF_ParamDef* params[],
...
) 
{
	return (PF_WORLD_IS_DEEP(output) ?
        AutomaticWhiteBalance2_InAE_DeepWorld (in_data, out_data, params, output) :
        AutomaticWhiteBalance2_InAE_8bits (in_data, out_data, params, output));
}