...
DLL_API_EXPORT void fft2d_f64 (const double* in, float* scratch, double* out, int sizeX, int sizeY);
...
DLL_API_EXPORT void ifft2d_f64(const double* in, float* scratch, double* out, int sizeX, int sizeY);
