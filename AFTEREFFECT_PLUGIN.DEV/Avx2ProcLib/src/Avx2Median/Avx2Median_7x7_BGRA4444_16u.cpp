...
inline void LoadLinePixel0 (uint64_t* __restrict pSrc, __m256i elemLine[4]) noexcept
{
	//  | X  0  0  0
...
inline void LoadLinePixel1 (uint64_t* __restrict pSrc, __m256i elemLine[5]) noexcept
{
	//  | 0  X  0  0  0
...
inline void LoadLinePixel2 (uint64_t* __restrict pSrc, __m256i elemLine[6]) noexcept
{
	// | 0  0  X  0  0  0
...
inline void LoadLinePixel (uint64_t* __restrict pSrc, __m256i elemLine[7]) noexcept
{
	// 0  0  0  X  0  0  0
...
inline void LoadLinePixelNminus2 (uint64_t* __restrict pSrc, __m256i elemLine[6]) noexcept
{
	// 0  0  0  X  0  0 |
	elemLine[0] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 3));
	elemLine[1] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 2));
...
inline void LoadLinePixelNminus1 (uint64_t* __restrict pSrc, __m256i elemLine[5]) noexcept
{
	// 0  0  0  X  0 |
	elemLine[0] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 3));
	elemLine[1] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 2));
...
inline void LoadLinePixelN (uint64_t* __restrict pSrc, __m256i elemLine[4]) noexcept
{
	// 0  0  0  X |
	elemLine[0] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 3));
	elemLine[1] = _mm256_loadu_si256(reinterpret_cast<__m256i*>(pSrc - 2));
...
(
	uint64_t* __restrict pSrc,
	uint64_t* __restrict pNext1,
	uint64_t* __restrict pNext2,
	uint64_t* __restrict pNext3,
	__m256i   elem[16]
) noexcept
{ 
...
(
	uint64_t* __restrict pPrev2,
	uint64_t* __restrict pPrev1,
	uint64_t* __restrict pSrc,
	uint64_t* __restrict pNext1,
	uint64_t* __restrict pNext2,
	uint64_t* __restrict pNext3,
...
{
	/* 14 x 2 */
	FullSort_14_elem_16u (a);
	FullSort_14_elem_16u (a + 14);

	/* merge between 2 x 14 */
	VectorSort16uPacked (a[0 ], a[27]);
	VectorSort16uPacked (a[1 ], a[26]);
	VectorSort16uPacked (a[2 ], a[25]);
	VectorSort16uPacked (a[3 ], a[24]);
	VectorSort16uPacked (a[4 ], a[23]);
	VectorSort16uPacked (a[5 ], a[22]);
	VectorSort16uPacked (a[6 ], a[21]);
	VectorSort16uPacked (a[7 ], a[20]);
	VectorSort16uPacked (a[8 ], a[19]);
	VectorSort16uPacked (a[9 ], a[18]);
	VectorSort16uPacked (a[10], a[17]);
	VectorSort16uPacked (a[11], a[16]);
	VectorSort16uPacked (a[12], a[15]);
	VectorSort16uPacked (a[13], a[14]);
	VectorSort16uPacked (a[0 ], a[14]);
	VectorSort16uPacked (a[1 ], a[15]);
	VectorSort16uPacked (a[2 ], a[16]);
	VectorSort16uPacked (a[3 ], a[17]);
	VectorSort16uPacked (a[4 ], a[18]);
	VectorSort16uPacked (a[5 ], a[19]);
	VectorSort16uPacked (a[6 ], a[20]);
	VectorSort16uPacked (a[7 ], a[21]);
	VectorSort16uPacked (a[8 ], a[22]);
	VectorSort16uPacked (a[9 ], a[23]);
	VectorSort16uPacked (a[10], a[24]);
	VectorSort16uPacked (a[11], a[25]);
	VectorSort16uPacked (a[12], a[26]);
	VectorSort16uPacked (a[13], a[27]);
	VectorSort16uPacked (a[6 ], a[9 ]);
	VectorSort16uPacked (a[7 ], a[10]);
	VectorSort16uPacked (a[8 ], a[11]);
	VectorSort16uPacked (a[9 ], a[12]);
	VectorSort16uPacked (a[10], a[13]);
...
{
	/* 15 x 2 */
	FullSort_15_elem_16u (a);
	FullSort_15_elem_16u (a + 15);

	/* merge sort 2 x 15 */
	VectorSort16uPacked (a[0 ], a[29]);
	VectorSort16uPacked (a[1 ], a[28]);
	VectorSort16uPacked (a[2 ], a[27]);
	VectorSort16uPacked (a[3 ], a[26]);
	VectorSort16uPacked (a[4 ], a[25]);
	VectorSort16uPacked (a[5 ], a[24]);
	VectorSort16uPacked (a[6 ], a[23]);
	VectorSort16uPacked (a[7 ], a[22]);
	VectorSort16uPacked (a[8 ], a[21]);
	VectorSort16uPacked (a[9 ], a[20]);
	VectorSort16uPacked (a[10], a[19]);
	VectorSort16uPacked (a[11], a[18]);
	VectorSort16uPacked (a[12], a[17]);
	VectorSort16uPacked (a[13], a[16]);
	VectorSort16uPacked (a[14], a[15]);
	VectorSort16uPacked (a[0 ], a[15]);
	VectorSort16uPacked (a[1 ], a[16]);
	VectorSort16uPacked (a[2 ], a[17]);
	VectorSort16uPacked (a[3 ], a[18]);
	VectorSort16uPacked (a[4 ], a[19]);
	VectorSort16uPacked (a[5 ], a[20]);
	VectorSort16uPacked (a[6 ], a[21]);
	VectorSort16uPacked (a[7 ], a[22]);
	VectorSort16uPacked (a[8 ], a[23]);
	VectorSort16uPacked (a[9 ], a[24]);
	VectorSort16uPacked (a[10], a[25]);
	VectorSort16uPacked (a[11], a[26]);
	VectorSort16uPacked (a[12], a[27]);
	VectorSort16uPacked (a[13], a[28]);
	VectorSort16uPacked (a[14], a[29]);
	VectorSort16uPacked (a[7 ], a[11]);
	VectorSort16uPacked (a[8 ], a[12]);
	VectorSort16uPacked (a[9 ], a[13]);
	VectorSort16uPacked (a[10], a[14]);
	VectorSort16uPacked (a[11], a[13]);
	VectorSort16uPacked (a[12], a[14]);
	VectorSort16uPacked (a[12], a[13]);
...
{
	/* 17 + 18 */
	FullSort_17_elem_16u (a);
	FullSort_18_elem_16u (a + 17);

	/* merge sort 17 + 18 */
	VectorSort16uPacked (a[0 ], a[34]);
	VectorSort16uPacked (a[1 ], a[33]);
	VectorSort16uPacked (a[2 ], a[32]);
	VectorSort16uPacked (a[3 ], a[31]);
	VectorSort16uPacked (a[4 ], a[30]);
	VectorSort16uPacked (a[5 ], a[29]);
	VectorSort16uPacked (a[6 ], a[28]);
	VectorSort16uPacked (a[7 ], a[27]);
	VectorSort16uPacked (a[8 ], a[26]);
	VectorSort16uPacked (a[9 ], a[25]);
	VectorSort16uPacked (a[10], a[24]);
	VectorSort16uPacked (a[11], a[23]);
	VectorSort16uPacked (a[12], a[22]);
	VectorSort16uPacked (a[13], a[21]);
	VectorSort16uPacked (a[14], a[20]);
	VectorSort16uPacked (a[15], a[19]);
	VectorSort16uPacked (a[16], a[18]);
	VectorSort16uPacked (a[17], a[18]);
	VectorSort16uPacked (a[0 ], a[8 ]);
	VectorSort16uPacked (a[1 ], a[9 ]);
	...
	VectorSort16uPacked (a[6 ], a[14]);
	VectorSort16uPacked (a[7 ], a[15]);
	VectorSort16uPacked (a[8 ], a[16]);
	VectorSort16uPacked (a[9 ], a[17]);
	VectorSort16uPacked (a[10], a[18]);
	VectorSort16uPacked (a[10], a[14]);
	VectorSort16uPacked (a[11], a[15]);
	VectorSort16uPacked (a[12], a[16]);
	VectorSort16uPacked (a[13], a[17]);
	VectorSort16uPacked (a[14], a[18]);
	VectorSort16uPacked (a[14], a[15]);
	VectorSort16uPacked (a[16], a[17]);
	VectorSort16uPacked (a[14], a[16]);
	VectorSort16uPacked (a[16], a[17]);
...
{
	/* 18 x 2 */
	FullSort_18_elem_16u (a);
	FullSort_18_elem_16u (a + 18);

	/* merge sort 2 x 18 */
	VectorSort16uPacked (a[0 ], a[35]);
	VectorSort16uPacked (a[1 ], a[34]);
	VectorSort16uPacked (a[2 ], a[33]);
	VectorSort16uPacked (a[3 ], a[32]);
	VectorSort16uPacked (a[4 ], a[31]);
	VectorSort16uPacked (a[5 ], a[30]);
	VectorSort16uPacked (a[6 ], a[29]);
	VectorSort16uPacked (a[7 ], a[28]);
	VectorSort16uPacked (a[8 ], a[27]);
	VectorSort16uPacked (a[9 ], a[26]);
	VectorSort16uPacked (a[10], a[25]);
	VectorSort16uPacked (a[11], a[24]);
	VectorSort16uPacked (a[12], a[23]);
	VectorSort16uPacked (a[13], a[22]);
	VectorSort16uPacked (a[14], a[21]);
	VectorSort16uPacked (a[15], a[20]);
	VectorSort16uPacked (a[16], a[19]);
	VectorSort16uPacked (a[17], a[18]);
	VectorSort16uPacked (a[0 ], a[9 ]);
	VectorSort16uPacked (a[1 ], a[10]);
	VectorSort16uPacked (a[2 ], a[11]);
	...
	VectorSort16uPacked (a[12], a[15]);
	VectorSort16uPacked (a[13], a[16]);
	VectorSort16uPacked (a[14], a[17]);
	VectorSort16uPacked (a[13], a[15]);
	VectorSort16uPacked (a[14], a[16]);
	VectorSort16uPacked (a[15], a[17]);
	VectorSort16uPacked (a[16], a[17]);
}
...
{
	/* 21 x 2 */
	FullSort_21_elem_16u (a);
	FullSort_21_elem_16u (a + 21);

	/* merge sort */
	VectorSort16uPacked (a[0 ], a[41]);
	VectorSort16uPacked (a[1 ], a[40]);
	VectorSort16uPacked (a[2 ], a[39]);
	VectorSort16uPacked (a[3 ], a[38]);
	VectorSort16uPacked (a[4 ], a[37]);
	VectorSort16uPacked (a[5 ], a[36]);
	VectorSort16uPacked (a[6 ], a[35]);
	VectorSort16uPacked (a[7 ], a[34]);
	VectorSort16uPacked (a[8 ], a[33]);
	VectorSort16uPacked (a[9 ], a[32]);
	VectorSort16uPacked (a[10], a[31]);
	VectorSort16uPacked (a[11], a[30]);
	VectorSort16uPacked (a[12], a[29]);
	VectorSort16uPacked (a[13], a[28]);
	VectorSort16uPacked (a[14], a[27]);
	VectorSort16uPacked (a[15], a[26]);
	VectorSort16uPacked (a[16], a[25]);
	VectorSort16uPacked (a[17], a[24]);
	VectorSort16uPacked (a[18], a[23]);
	VectorSort16uPacked (a[19], a[22]);
	VectorSort16uPacked (a[20], a[21]);
	VectorSort16uPacked (a[0 ], a[10]);
	VectorSort16uPacked (a[1 ], a[11]);
	VectorSort16uPacked (a[2 ], a[12]);
	VectorSort16uPacked (a[3 ], a[13]);
	VectorSort16uPacked (a[4 ], a[14]);
	VectorSort16uPacked (a[5 ], a[15]);
	VectorSort16uPacked (a[6 ], a[16]);
	VectorSort16uPacked (a[7 ], a[17]);
	VectorSort16uPacked (a[8 ], a[18]);
	VectorSort16uPacked (a[9 ], a[19]);
	VectorSort16uPacked (a[10], a[20]);
	VectorSort16uPacked (a[5 ], a[15]);
	VectorSort16uPacked (a[6 ], a[16]);
	VectorSort16uPacked (a[7 ], a[17]);
	...
	VectorSort16uPacked (a[9 ], a[19]);
	VectorSort16uPacked (a[10], a[20]);
	VectorSort16uPacked (a[15], a[18]);
	VectorSort16uPacked (a[17], a[19]);
	VectorSort16uPacked (a[18], a[20]);
	VectorSort16uPacked (a[18], a[19]);
	VectorSort16uPacked (a[19], a[20]);
}

inline void PartialSort_49_elem_8u (__m256i a[49]) noexcept
{
	/* sort lower 24 element using best NET */
	FullSort_24_elem_16u (a);
	FullSort_24_elem_16u (a + 24);

	/* merge sort */
	VectorSort16uPacked (a[0 ], a[48]);
	VectorSort16uPacked (a[1 ], a[47]);
	VectorSort16uPacked (a[2 ], a[46]);
	VectorSort16uPacked (a[3 ], a[45]);
	VectorSort16uPacked (a[4 ], a[44]);
	VectorSort16uPacked (a[5 ], a[43]);
	VectorSort16uPacked (a[6 ], a[42]);
	VectorSort16uPacked (a[7 ], a[41]);
	VectorSort16uPacked (a[8 ], a[40]);
	VectorSort16uPacked (a[9 ], a[39]);
	VectorSort16uPacked (a[10], a[38]);
	VectorSort16uPacked (a[11], a[37]);
	VectorSort16uPacked (a[12], a[36]);
	VectorSort16uPacked (a[13], a[35]);
	VectorSort16uPacked (a[14], a[34]);
	VectorSort16uPacked (a[15], a[33]);
	VectorSort16uPacked (a[16], a[32]);
	VectorSort16uPacked (a[17], a[31]);
	VectorSort16uPacked (a[18], a[30]);
	VectorSort16uPacked (a[19], a[29]);
	VectorSort16uPacked (a[20], a[28]);
	VectorSort16uPacked (a[21], a[27]);
	VectorSort16uPacked (a[22], a[26]);
	VectorSort16uPacked (a[23], a[25]);
	VectorSort16uPacked (a[24], a[25]);
	VectorSort16uPacked (a[23], a[24]);
	VectorSort16uPacked (a[0],  a[12]);
	VectorSort16uPacked (a[1],  a[13]);
	VectorSort16uPacked (a[2],  a[14]);
	VectorSort16uPacked (a[3],  a[15]);
	VectorSort16uPacked (a[4],  a[16]);
	VectorSort16uPacked (a[5],  a[17]);
	VectorSort16uPacked (a[6],  a[18]);
	VectorSort16uPacked (a[7],  a[19]);
	VectorSort16uPacked (a[8],  a[20]);
	VectorSort16uPacked (a[9],  a[21]);
	VectorSort16uPacked (a[10], a[22]);
	VectorSort16uPacked (a[11], a[23]);
	VectorSort16uPacked (a[12], a[24]);
	VectorSort16uPacked (a[13], a[19]);
	VectorSort16uPacked (a[14], a[20]);
	VectorSort16uPacked (a[15], a[21]);
	VectorSort16uPacked (a[16], a[22]);
	VectorSort16uPacked (a[17], a[23]);
	VectorSort16uPacked (a[18], a[24]);
	VectorSort16uPacked (a[16], a[21]);
	VectorSort16uPacked (a[17], a[22]);
	VectorSort16uPacked (a[18], a[23]);
	VectorSort16uPacked (a[19], a[24]);
	VectorSort16uPacked (a[17], a[21]);
	VectorSort16uPacked (a[18], a[22]);
	VectorSort16uPacked (a[19], a[23]);
	VectorSort16uPacked (a[20], a[24]);
	VectorSort16uPacked (a[21], a[23]);
	VectorSort16uPacked (a[22], a[24]);
	VectorSort16uPacked (a[23], a[24]);
}
...
bool AVX2::Median::median_filter_7x7_RGB_4444_16u
(
...
//		return Scalar::scalar_median_filter_7x7_BGRA_4444_8u(pInImage, pOutImage, sizeY, sizeX, linePitch);
	...
	/* PROCESS FIRST LINE IN FRAME */
	{
		...
		uint64_t* __restrict pSrcVecNextLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch);
		uint64_t* __restrict pSrcVecNextLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 2);
		uint64_t* __restrict pSrcVecNextLine3 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 3);
	...
	{
		uint64_t* __restrict pSrcVecPrevLine  = reinterpret_cast<uint64_t* __restrict>(pInImage);
		uint64_t* __restrict pSrcVecCurrLine  = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch);
		uint64_t* __restrict pSrcVecNextLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 2);
		uint64_t* __restrict pSrcVecNextLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 3);
		uint64_t* __restrict pSrcVecNextLine3 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 4);
	...
	{
		uint64_t* __restrict pSrcVecPrevLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage);
		uint64_t* __restrict pSrcVecPrevLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch);
		uint64_t* __restrict pSrcVecCurrLine  = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 2);
		uint64_t* __restrict pSrcVecNextLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 3);
		uint64_t* __restrict pSrcVecNextLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 4);
		uint64_t* __restrict pSrcVecNextLine3 = reinterpret_cast<uint64_t* __restrict>(pInImage + srcLinePitch * 5);
	...
	{
			uint64_t* __restrict pSrcVecPrevLine3 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j - 3) * srcLinePitch);
			uint64_t* __restrict pSrcVecPrevLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j - 2) * srcLinePitch);
			uint64_t* __restrict pSrcVecPrevLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j - 1) * srcLinePitch);
			uint64_t* __restrict pSrcVecCurrLine  = reinterpret_cast<uint64_t* __restrict>(pInImage  +  j      * srcLinePitch);
			uint64_t* __restrict pSrcVecNextLine1 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j + 1) * srcLinePitch);
			uint64_t* __restrict pSrcVecNextLine2 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j + 2) * srcLinePitch);
			uint64_t* __restrict pSrcVecNextLine3 = reinterpret_cast<uint64_t* __restrict>(pInImage  + (j + 3) * srcLinePitch);
