#ifndef __IMAGE_LAB_ART_POINTILISM_PAINTER_PISSARRO_TECHNICS__
#define __IMAGE_LAB_ART_POINTILISM_PAINTER_PISSARRO_TECHNICS__

#include <array>
#include "ArtPointillismPalette.hpp"
#include "Common.hpp"

using Pissarro_Palette_u8  = std::array<PEntry<uint8_t>, 12>;
using Pissarro_Palette_f32 = std::array<PEntry<float>, 12>;
