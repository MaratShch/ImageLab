#ifndef __IMAGE_LAB_PRISMA_FILTER_EXT_MEM_INTERFACE__
#define __IMAGE_LAB_PRISMA_FILTER_EXT_MEM_INTERFACE__
...
#endif // __IMAGE_LAB_PRISMA_FILTER_EXT_MEM_INTERFACE__