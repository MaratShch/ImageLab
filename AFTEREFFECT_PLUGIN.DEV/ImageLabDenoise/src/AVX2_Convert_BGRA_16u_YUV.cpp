...
) noexcept
{
    ...
    {
        const PF_Pixel_BGRA_16u* rowIn = pInput + (y * linePitch);
        ...
        {
            // Gather 16-bit integers and pack them directly into 32-bit registers.
            // This avoids complex 128-bit lane crossovers and endian issues.
