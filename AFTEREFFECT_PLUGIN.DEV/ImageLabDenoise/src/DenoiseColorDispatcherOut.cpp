...
// ============================================================================
// THE PUBLIC OUTPUT DISPATCH API (Inverse Orthonormal out to Adobe)
// ============================================================================
void dispatch_convert_to_interleaved
(
    const MemHandler& memHndl,
    const void* RESTRICT origSrcBuf, // The original Adobe Input buffer (for pure Alpha extraction)
...
{
    // Localized macro that directly instantiates our full-resolution AVX2 template
