#ifndef __IMAGE_LAB_ADATED_FREQUENCY_MEDIAN_FILTER_MEM_INTERFACE__
#define __IMAGE_LAB_ADATED_FREQUENCY_MEDIAN_FILTER_MEM_INTERFACE__
...
#endif // __IMAGE_LAB_ADATED_FREQUENCY_MEDIAN_FILTER_MEM_INTERFACE__