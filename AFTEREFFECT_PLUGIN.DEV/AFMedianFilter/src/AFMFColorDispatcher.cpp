#include "AFMFColorPlanar.hpp"


// ============================================================================
// THE PUBLIC DISPATCH API (Interleaved to Planar RGB Ingest)
// ============================================================================
...
{
    // Localized macro to keep the switch statement clean.
    // Instantiates the C++14 AVX2 template for Unpacking to Planar RGB.
    ...
    switch (format)
    {
        ...
        // YUV Interleaved Formats (Automatically decoded to RGB via Traits)
        ...
        default:
            // Fallback for unhandled inputs to prevent crashes.
        break;
    }
