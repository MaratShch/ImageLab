	...
	PF_LayerDef		*output)
{
	PF_SPRINTF(
		...
		"%s, v%d.%d\r%s",
		strName,
		AFMedianFilter_VersionMajor,
		AFMedianFilter_VersionMinor,
		strCopyright);
	...
	PF_LayerDef		*output)
{
	...
	out_data->my_version =
		PF_VERSION(
			AFMedianFilter_VersionMajor,
			AFMedianFilter_VersionMinor,
			AFMedianFilter_VersionSub,
			AFMedianFilter_VersionStage,
			AFMedianFilter_VersionBuild
		);
...
{
    return AFMedianFilter_PreRender (in_data, out_data, extra);
}
...
{
    return AFMedianFilter_SmartRender (in_data, out_data, extraP);
}
