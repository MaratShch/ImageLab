...
//   entry[i] = sRGB (IEC 61966-2-1, piecewise) decode of (i / 255)
//   index    = RAW integer pixel code, 0..255
...
#ifndef __IMAGELAB2_LINEARIZE_LUT_SRGB_8BIT_F64_DECL__
...
{
    constexpr std::size_t LINEARIZE_LUT_SRGB_8BIT_F64_SIZE = 256u;
