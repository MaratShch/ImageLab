...
# Wolfenstein 3D Inspired EGA Palette (Custom Interpretation)
EGA_WOLFENSTEIN_PALETTE = [
    (0, 0, 0), (50, 50, 50), (80, 70, 60), (100, 70, 40),
    (120, 0, 0), (100, 50, 40), (150, 60, 40), (180, 120, 80),
    (100, 100, 100), (160, 160, 160), (80, 100, 80), (70, 80, 100),
    (255, 0, 0), (200, 160, 80), (255, 255, 80), (255, 255, 255)
]
...
if __name__ == "__main__":
    ...
    # NEW EGA Metal Mutant Inspired
    draw_palette_pattern_logo("retro_logos_pattern_all/ega_metal_mutant_pattern.png", EGA_METAL_MUTANT_PALETTE, 12, 12)
    # NEW EGA Wolfenstein Inspired
    draw_palette_pattern_logo("retro_logos_pattern_all/ega_wolfenstein_pattern.png", EGA_WOLFENSTEIN_PALETTE, 12, 12)