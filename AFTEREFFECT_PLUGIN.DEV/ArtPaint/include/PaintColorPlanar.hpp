...
) noexcept
{
    ...
    for (A_long y = 0; y < out_height; ++y)
    {
        ...
        for (; x_out <= out_width - 8; x_out += 8)
        {
            ...
            __m256 v_Y_val = _mm256_add_ps(_mm256_mul_ps(v_y_r, vR_sum), _mm256_add_ps(_mm256_mul_ps(v_y_g, vG_sum), _mm256_mul_ps(v_y_b, vB_sum)));
            __m256 v_U_val = _mm256_add_ps(_mm256_mul_ps(v_u_r, vR_sum), _mm256_add_ps(_mm256_mul_ps(v_u_g, vG_sum), _mm256_mul_ps(v_u_b, vB_sum)));
            __m256 v_V_val = _mm256_add_ps(_mm256_mul_ps(v_v_r, vR_sum), _mm256_add_ps(_mm256_mul_ps(v_v_g, vG_sum), _mm256_mul_ps(v_v_b, vB_sum)));
        ...
        if (remaining > 0)
        {
            alignas(32) PixelType tail0[16] = {}, tail1[16] = {};
            ...
            alignas(32) float tY[8], tU[8], tV[8];
...
) noexcept
{
    ...
    for (A_long y = 0; y < height; ++y)
    {
        ...
        for (; x <= width - 8; x += 8)
        {
            ...
            __m256 v_Y_val = _mm256_add_ps(_mm256_mul_ps(v_y_r, vR), _mm256_add_ps(_mm256_mul_ps(v_y_g, vG), _mm256_mul_ps(v_y_b, vB)));
            __m256 v_U_val = _mm256_add_ps(_mm256_mul_ps(v_u_r, vR), _mm256_add_ps(_mm256_mul_ps(v_u_g, vG), _mm256_mul_ps(v_u_b, vB)));
            __m256 v_V_val = _mm256_add_ps(_mm256_mul_ps(v_v_r, vR), _mm256_add_ps(_mm256_mul_ps(v_v_g, vG), _mm256_mul_ps(v_v_b, vB)));
        ...
        if (remaining > 0)
        {
            alignas(32) PixelType tail_src[8] = {};
