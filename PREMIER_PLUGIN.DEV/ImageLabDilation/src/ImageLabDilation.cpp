		...
		if (nullptr != PPixSuite && kSPNoError == err)
		{
			...
			switch (pixelFormat)
			{
				...
				case PrPixelFormat_BGRA_4444_8u:
				{
					...
					processSucceed = dilation_BGRA_4444_8u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_VUYA_4444_8u_709:
				{
					...
					processSucceed = dilation_VUYA_4444_8u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_BGRA_4444_16u:
				{
					...
					processSucceed = dilation_BGRA_4444_16u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_BGRA_4444_32f:
				{
					...
					processSucceed = dilation_BGRA_4444_32f(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_VUYA_4444_32f_709:
				{
					...
					processSucceed = dilation_VUYA_4444_32f(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_ARGB_4444_8u:
				{
					...
					processSucceed = dilation_ARGB_4444_8u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_ARGB_4444_16u:
				{
					...
					processSucceed = dilation_ARGB_4444_16u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_ARGB_4444_32f:
				{
					...
					processSucceed = dilation_ARGB_4444_32f(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
				...
				case PrPixelFormat_RGB_444_10u:
				{
					...
					processSucceed = dilation_RGB_444_10u(pSrcPix, pDstPix, width, height, linePitch, defaultWindowSize);
				}
				break;
